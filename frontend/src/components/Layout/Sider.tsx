...
function buildMenuItems(t: (k: string) => string): MenuItemWithPerm[] {
  return [
    ...
    },
    {
      ...
      icon: <PauseOutlined />,
      label: t('menu.sales'),
      permissions: ['sales:customer', 'sales:quote', 'sales:order', 'sales:delivery', 'sales:service'],
      children: [
    ...
    },
    {
      ...
      label: t('menu.system'),
      permissions: ['user:manage', 'user:view', 'role:manage', 'system:config', 'integration:sync', 'system:audit', 'system:tenant', 'file:manage'],
      children: [
